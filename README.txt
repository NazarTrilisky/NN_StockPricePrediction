  ...
  From a personal investment standpoint, I am sticking to old school value investing.  The NN model may work for large investment institutions that have high trading volumes and the small edge will give them an average.  My number of trades is too small to justify using the NN as a key decision factor.  My site http://marketmeaning.com reflects one more favorable approach: comparing insider and outsider sentiment to make buy/sell decisions.
