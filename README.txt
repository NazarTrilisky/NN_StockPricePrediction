  Abstract
  This project searched for patterns in technical data (prices, volumes) and fundamentals data (54 metrics) that will predict future stock prices.  Neural networks were used as models.
